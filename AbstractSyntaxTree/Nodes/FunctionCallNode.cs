...
public record FunctionCallNode(IAstNode Id, IAstNode? Qualifier, ImmutableArray<IAstNode> Parameters, IAstNode? CalledOn, int Line, int Column) : IAstNode, ICanWrapExpression, ICallNode {
