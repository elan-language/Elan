...
public record AbstractClassDefModel(ICodeModel Type, IEnumerable<ICodeModel> Inherits, IEnumerable<ICodeModel> Properties, IEnumerable<ICodeModel> Functions, ICodeModel DefaultClassModel) : ICodeModel {
